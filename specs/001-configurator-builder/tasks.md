...
- [x] T008 [US2] Wire viewer utility controls (`DimensionHUD`, `FullscreenButton`, `ScreenshotButton`) in `src/components/viewer/` to respect builder toggles (AC-UI-BLD-001)
